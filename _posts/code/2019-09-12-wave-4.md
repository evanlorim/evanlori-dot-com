...
images:
  - public_id: archive/code/wavy-shaders-shimmer
  - public_id: archive/code/wavy-shaders-grain
  - public_id: archive/code/wavy-shaders-xmas
  - public_id: archive/code/wavy-shaders-barb
